...
<div class="col-md-6 col-md-offset-3">
	...
	<form class="panel panel-default" method="post" action="{{ url('excel/close_book') }}" enctype="multipart/form-data">
		{{ csrf_field() }}
		<div class="panel-heading text-center">
			<i class="icon-drawer3 icon-3x"></i>
			<h4 class="panel-title text-center">@lang('trans.import_close_book')</h4>
		</div>
