...
<div class="col-md-6 col-md-offset-3">
	<form class="panel panel-default" method="post" action="{{ url('excel/stock_master') }}" enctype="multipart/form-data">
		{{ csrf_field() }}
		<div class="panel-heading text-center">
			<i class="icon-cube3 icon-3x"></i>
			<h4 class="panel-title text-center">@lang('trans.import_stock_master')</h4>
		</div>
		...
		<div class="panel-body">
			...
			<div class="form-group">
				<label class="radio-inline">
					<input type="radio" name="type" value="tire" class="styled" checked="checked">
					@lang('trans.ban')
				</label>
				<label class="radio-inline">
					<input type="radio" name="type" value="battery" class="styled">
					@lang('trans.battery')
				</label>
				<label class="radio-inline">
					<input type="radio" name="type" value="velg" class="styled">
					@lang('trans.velg')
				</label>
			</div>
		...
		<div class="panel-footer p-20">
			<a href="{{ url('stock_master') }}" class="btn btn-default"><i class="icon-circle-left2 position-left"></i> @lang('trans.back')</a>
