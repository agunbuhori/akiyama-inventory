...
<div class="col-md-6 col-md-offset-3">
	<form class="panel panel-default" method="post" action="{{ url('excel/bs_stock') }}" enctype="multipart/form-data">
		{{ csrf_field() }}
		<div class="panel-heading text-center">
			<i class="icon-stack3 icon-3x"></i>
			<h4 class="panel-title text-center">@lang('trans.import_bs_stock')</h4>
		</div>
		...
		<div class="panel-body">
			...
			<div class="form-group">
				<label class="radio-inline">
					<input type="radio" name="titip" value="barang_biasa" class="styled" checked="checked">
					@lang('trans.barang_biasa')
				</label>
				<label class="radio-inline">
					<input type="radio" name="titip" value="barang_titip" class="styled">
					@lang('trans.barang_titip')
				</label>
			</div>
			<input type="file" class="file-input" name="csv" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
		</div>

		<div class="panel-footer p-20">
			<a href="{{ url('bs_stock') }}" class="btn btn-default"><i class="icon-circle-left2 position-left"></i> @lang('trans.back')</a>
			<div class="pull-right">
				<button class="btn btn-success"><i class="icon-upload position-left"></i> @lang('trans.upload')</button>
			</div>
		</div>
	</form>
</div>
